...
StyledRect {
    ...
    property bool expanded: GlobalConfig.notifs.openExpanded
    ...
    MouseArea {
        ...
        onReleased: event => {
            ...
            if (Math.abs(root.x) < root.implicitWidth * GlobalConfig.notifs.clearThreshold)
                root.x = 0;
            else
        ...
        onPositionChanged: event => {
            if (pressed) {
                ...
                if (Math.abs(diffY) > GlobalConfig.notifs.expandThreshold)
            ...
            Loader {
                ...
                sourceComponent: StyledClippingRect {
                    ...
                    Image {
                        ...
                        sourceSize: {
                            const size = Tokens.sizes.notifs.image * ((Screen.devicePixelRatio) ?? 1);
