...
nix-shell -p disko
sudo disko --mode disko --flake github:sean-imus/nixos-config#work-notebook
...
# 4. Install
sudo nixos-install --no-channel-copy --no-root-password --flake github:sean-imus/nixos-config#work-notebook
